...
- [x] **webpack** (~> 5.0) - Module bundler
  ...
  - **Key locations**:
    - `apps/webpack.config.js:1` - Webpack configuration
    - `apps/webpackEntryPoints.js:1` - Entry points configuration
...
- [x] **webpack-cli** (~> 5.0) - Webpack command line interface
  ...
  - **Key locations**:
    - `apps/package.json:15` - CLI scripts
...
- [x] **webpack-dev-server** (~> 4.0) - Development server
  ...
  - **Key locations**:
    - `apps/webpack.config.js:25` - Dev server configuration
...
- [x] **@babel/core** (~> 7.0) - Babel core transpiler
  ...
  - **Key locations**:
    - `apps/babel.config.json:1` - Babel configuration
    - `apps/webpack.config.js:30` - Babel loader
...
- [x] **@babel/preset-env** (~> 7.0) - Babel environment preset
  ...
  - **Key locations**:
    - `apps/babel.config.json:5` - Preset configuration
...
- [x] **@babel/preset-react** (~> 7.0) - Babel React preset
  ...
  - **Key locations**:
    - `apps/babel.config.json:7` - React preset configuration
...
- [x] **babel-loader** (~> 9.0) - Webpack Babel loader
  ...
  - **Files**: Found in 5 files across the codebase
  - **Key locations**:
    - `apps/webpack.config.js:35` - Babel loader configuration
...
- [x] **sass** (~> 1.0) - Sass CSS preprocessor
  ...
  - **Key locations**:
    - `apps/webpack.config.js:40` - Sass loader configuration
...
- [x] **sass-loader** (~> 13.0) - Webpack Sass loader
  ...
  - **Files**: Found in 3 files across the codebase
  - **Key locations**:
    - `apps/webpack.config.js:42` - Sass loader configuration
...
- [x] **css-loader** (~> 6.0) - Webpack CSS loader
  ...
  - **Key locations**:
    - `apps/webpack.config.js:45` - CSS loader configuration
...
- [x] **style-loader** (~> 3.0) - Webpack style loader
  ...
  - **Files**: Found in 3 files across the codebase
  - **Key locations**:
    - `apps/webpack.config.js:48` - Style loader configuration
...
- [x] **terser-webpack-plugin** (~> 5.0) - JavaScript minification
  ...
  - **Files**: Found in 3 files across the codebase
  - **Key locations**:
    - `apps/webpack.config.js:50` - Terser plugin configuration
...
- [x] **uglify-js** (~> 3.0) - JavaScript minification (legacy)
  ...
  - **Key locations**:
    - `apps/webpack.config.js:52` - Uglify configuration
...
- [x] **webpack-bundle-analyzer** (~> 4.0) - Bundle analysis
  ...
  - **Files**: Found in 2 files across the codebase
  - **Key locations**:
    - `apps/webpack.config.js:55` - Bundle analyzer configuration
...
- [x] **webpack-manifest-plugin** (~> 5.0) - Asset manifest generation
  ...
  - **Files**: Found in 2 files across the codebase
  - **Key locations**:
    - `apps/webpack.config.js:58` - Manifest plugin configuration
...
- [x] **grunt** (~> 1.0) - JavaScript task runner
  ...
  - **Files**: Found in 8 files across the codebase
  - **Key locations**:
    - `apps/Gruntfile.js:1` - Grunt configuration
    - `apps/package.json:20` - Grunt scripts
...
- [x] **grunt-cli** (~> 1.0) - Grunt command line interface
  ...
  - **Files**: Found in 2 files across the codebase
  - **Key locations**:
    - `apps/package.json:22` - CLI scripts
