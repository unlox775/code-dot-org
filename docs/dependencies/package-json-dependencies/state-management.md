...
- [x] **@reduxjs/toolkit** (^1.9.3) - Redux toolkit
  ...
  - **Key locations**:
    - `apps/src/redux/commonReducers.js:1` - Common Redux reducers
    - `apps/src/weblab2/redux.ts:2` - WebLab Redux store
...
- [x] **redux-logger** (^2.6.1) - Redux logging middleware
  ...
  - **Key locations**:
    - `apps/src/redux/store.js:1` - Redux store configuration
    - `apps/test/util/redux.js:2` - Redux testing utilities
    - `apps/src/util/reduxHooks.ts:3` - Redux hooks with logging
...
- [x] **redux-thunk** (^2.0.1) - Redux async actions
  ...
  - **Key locations**:
    - `apps/src/redux/actions.js:1` - Redux actions
    - `apps/src/weblab/actions.js:1` - WebLab actions
...
- [x] **redux-mock-store** (^1.2.3) - Redux testing utilities
  ...
  - **Key locations**:
    - `apps/test/util/withReduxStore.js:2` - Redux store testing utilities
    - `apps/test/unit/redux/watchedExpressionsTest.js:1` - Redux tests
    - `apps/test/unit/redux/feedbackTest.js:1` - Redux feedback tests
...
- [x] **redux-persist** (^6.0.0) - Redux state persistence
  ...
  - **Key locations**:
    - `apps/src/redux/store.js:5` - Redux store with persistence
    - `apps/src/util/reduxHooks.ts:3` - Redux hooks with persistence
    - `apps/src/templates/AppView.jsx:3` - App view with persisted state
...
- [x] **reselect** (^4.1.8) - Redux state selectors
  ...
  - **Key locations**:
    - `apps/src/redux/selectors.js:1` - Redux selectors
    - `apps/src/weblab/selectors.js:1` - WebLab selectors
