...
- [x] **cucumber** (~> 7.0) - Behavior-driven development testing
  ...
  - **Key locations**:
    ...
    - `dashboard/support/env.rb:1` - Cucumber configuration
...
- [x] **faker** (~> 2.19) - Fake data generation for tests
  ...
  - **Key locations**:
    - `dashboard/spec/factories/user.rb:5` - Fake user data
    - `dashboard/spec/factories/course.rb:3` - Fake course data
...
- [x] **rubocop** (~> 1.25) - Ruby static code analyzer
  ...
  - **Key locations**:
    - `dashboard/.rubocop.yml:1` - RuboCop configuration
...
- [x] **rubocop-factory_bot** (~> 2.15) - RuboCop extension for Factory Bot
  ...
  - **Files**: Found in 3 files across the codebase
  - **Key locations**:
    - `dashboard/.rubocop.yml:15` - Factory Bot rules
...
- [x] **rubocop-performance** (~> 1.13) - RuboCop performance rules
  ...
  - **Files**: Found in 3 files across the codebase
  - **Key locations**:
    - `dashboard/.rubocop.yml:20` - Performance rules
...
- [x] **rubocop-rails** (~> 2.13) - RuboCop Rails rules
  ...
  - **Files**: Found in 3 files across the codebase
  - **Key locations**:
    - `dashboard/.rubocop.yml:25` - Rails rules
...
- [x] **rubocop-rails-accessibility** (~> 0.1) - RuboCop accessibility rules
  ...
  - **Key locations**:
    - `dashboard/.rubocop.yml:30` - Accessibility rules
...
- [x] **vcr** (~> 6.0) - HTTP interaction recording
  ...
  - **Files**: Found in 10+ files across the codebase
  - **Key locations**:
    - `dashboard/spec/support/vcr.rb:1` - VCR configuration
