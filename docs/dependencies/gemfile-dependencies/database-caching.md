...
- [x] **mysql2** (>= 0.4.1) - MySQL database adapter
  ...
  - **Key locations**:
    ...
    - `dashboard/config/database.yml:1` - Database configuration
...
- [x] **pg** (1.4.6) - PostgreSQL database adapter
  ...
  - **Key locations**:
    - `dashboard/config/database.yml:15` - PostgreSQL configuration
...
- [x] **redis** (~> 4.8.1) - Redis caching system
  ...
  - **Key locations**:
    - `lib/cdo/geocoder.rb:1` - Geocoding cache
...
- [x] **redis-actionpack** (5.2.0) - Redis session store for ActionPack
  ...
  - **Key locations**:
    - `dashboard/config/initializers/session_store.rb:1` - Session store configuration
    - `lib/cdo/session_management.rb:1` - Session management utilities
    - `dashboard/config/application.rb:40` - Session configuration
...
- [x] **redis-slave-read** (1.3.0) - Redis read from slave
  ...
  - **Key locations**:
    ...
    - `dashboard/config/initializers/redis.rb:1` - Redis configuration
...
- [x] **composite_primary_keys** (12.0.0) - Composite primary keys for ActiveRecord
  ...
  - **Key locations**:
    ...
    - `dashboard/app/models/level_group.rb:1` - Level group model
...
- [x] **paranoia** (2.6.0) - Soft delete for ActiveRecord
  ...
  - **Key locations**:
    - `dashboard/app/models/concerns/soft_delete.rb:1` - Soft delete concerns
    - `lib/cdo/soft_delete_utils.rb:1` - Soft delete utilities
    - `dashboard/app/models/user.rb:1` - User model with soft delete
