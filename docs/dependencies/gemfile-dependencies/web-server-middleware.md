...
- [x] **sinatra** (2.2.0) - Lightweight web framework
  ...
  - **Key locations**:
    - `pegasus/router.rb:1` - Main routing system
    - `pegasus/app.rb:1` - Sinatra application setup
    - `pegasus/helpers.rb:1` - Sinatra helper methods
...
- [x] **puma** (5.6.5) - Ruby web server
  ...
  - **Key locations**:
    - `dashboard/config/puma.rb:1` - Puma configuration
    - `dashboard/config/application.rb:20` - Server configuration
...
- [x] **puma_worker_killer** (0.3.1) - Puma worker management
  ...
  - **Key locations**:
    - `dashboard/config/puma.rb:15` - Worker killer configuration
    - `lib/cdo/server_monitoring.rb:1` - Server monitoring utilities
    - `dashboard/config/initializers/puma.rb:1` - Puma initialization
...
- [x] **raindrops** (0.20.0) - Unix socket monitoring
  ...
  - **Key locations**:
    - `lib/cdo/server_metrics.rb:1` - Server metrics collection
...
- [x] **rack-cache** (1.15.0) - HTTP caching middleware
  ...
  - **Key locations**:
    - `dashboard/config/application.rb:25` - Rack cache configuration
    - `lib/cdo/caching_middleware.rb:1` - Custom caching middleware
    - `dashboard/config/initializers/caching.rb:1` - Caching configuration
...
- [x] **rack-ssl-enforcer** (0.3.0) - SSL enforcement middleware
  ...
  - **Key locations**:
    - `dashboard/config/application.rb:30` - SSL enforcement configuration
    - `lib/cdo/security_middleware.rb:1` - Security middleware utilities
    - `dashboard/config/initializers/ssl.rb:1` - SSL configuration
...
- [x] **rack-cors** (1.1.1) - Cross-Origin Resource Sharing middleware
  ...
  - **Key locations**:
    - `dashboard/config/application.rb:35` - CORS configuration
