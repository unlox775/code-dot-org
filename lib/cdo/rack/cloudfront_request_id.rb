...
module Rack
  ...
  class CloudFrontRequestId
    CLOUDFRONT_HEADER = 'HTTP_X_AMZ_CF_ID'.freeze
    REQUEST_ID_HEADER = 'HTTP_X_REQUEST_ID'.freeze
    REQUEST_ID_ENV    = 'action_dispatch.request_id'.freeze
    CDO_REQUEST_ID    = 'cdo.request_id'.freeze
    CDO_CF_REQUEST_ID = 'cdo.cloudfront_request_id'.freeze
